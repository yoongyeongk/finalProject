...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "MAn71SNNZHBVz0vV6Qs3";
	private final static String CLIENT_SECRET = "qeoK4kW6Tv";
	private final static String REDIRECT_URI = "http://localhost/project/users/callback";
