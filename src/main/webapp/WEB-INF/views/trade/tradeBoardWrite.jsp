					...
					<div class="box" style="margin-bottom: 20px;">
						...
						<div class="box" style="height:auto;">
							...
							<div id="fileBox">
								...
								<div class="line">
									<div class="addBox">
										<input type="button" value="주소찾기" class="ad b" onclick="sample2_execDaumPostcode()"><span class="star"> *</span><br>
										<input style="margin-top: 10px;" type="text" id="address" name="address" value="${one.address }">
										<input type="text" id="address_detail" name="address_detail" placeholder="상세주소" value="${one.address_detail }">
									</div>
